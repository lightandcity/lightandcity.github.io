      ...
      $.ajax({
        ...
        success: function(res) {
          if (res.msg === 'SUCCESS') {
            ...
            $('._block_' + writer).text(getLocalizeString("설명_차단해제", "", "차단해제")).attr("onclick", "BOARD_COMMON.deleteBlock('" + res.post_code + "','" + writer + "', 'comment', '" + bord_code + "','" + current_page + "')");
            ...
            $('._board._block_' + writer).text(getLocalizeString("설명_차단해제", "", "차단해제")).attr("onclick", "BOARD_COMMON.deleteBlock('" + res.post_code + "','" + writer + "', 'post', '" + bord_code + "','" + current_page + "')");
          } else {
            alert(res.msg);
          }
        }
      ...
      $.ajax({
        ...
        success: function(res) {
          if (res.msg === 'SUCCESS') {
            ...
            $('._board._block_' + writer).text(getLocalizeString("설명_차단", "", "차단")).attr("onclick", "BOARD_COMMON.addBlock('" + res.code + "','" + writer + "','post','" + bord_code + "');");
          } else {
            alert(res.msg)
          }
        }
